local mod = require(game:GetService("Players").PUTURUSERHERE.PlayerScripts.Aero.Controllers.UI.Pets) -- put your user their 
setconstant(mod.CalculatePetCapacity, 7, 700)

getgenv().autoTap = false; -- set these to true to work
getgenv().autoRebirth = false; -- set these to true to work
getgenv().BuyEgg = false; -- set these to true to work
